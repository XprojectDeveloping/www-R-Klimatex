    ...
    <>
      <section className="services-bg flex items-center justify-center flex-col relative">
        ...
        <div className="flex items-center justify-center flex-col h-[500px] absolute">
          <h2 className="pb-[1.3rem] text-[5.5rem] lg:text-[4rem] font-semibold leading-[100%] text-[#ffffff]">
            {h2Title}
          </h2>
          <p className="text-[3.2rem] lg:text-[2.5rem] font-normal leading-[100%] text-[#ffffff]">
            {pText}
          </p>
        </div>
      </section>
